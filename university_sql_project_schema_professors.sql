...
CREATE TABLE `professors` (
  ...
  `professors_name` varchar(80) DEFAULT NULL,
  `professors_email_address` varchar(100) NOT NULL,
  PRIMARY KEY (`professors_id`),
  UNIQUE KEY `professors_id_UNIQUE` (`professors_id`),
  UNIQUE KEY `professors_email_address_UNIQUE` (`professors_email_address`)
...
INSERT INTO `professors` VALUES (1,'Jordan','jordan@demo.com'),(2,'Joaquín','joaquin@demo.com'),(3,'Carlos','carlos@demo.com');
